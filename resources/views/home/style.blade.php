        ...
        <style>
            ...
            .add-to-cart{border:1px solid #e5e5e5;background:#004134;display:inline-block;padding:10px 20px;color:white;font-weight:600;font-size:14px;border-radius:4px;transition:all .3s}
            .add-to-cart{border:1px solid transparent;background:#86c9bb;color:#fff}
            .add-to-cart:hover{background-color:#505050;color:#fff !important;cursor:pointer;}
            .add-to-cart a:hover{color:white!important}
            /********************* Shopping Demo-4 **********************/
            ...
            .product-grid4 .add-to-cart{border:1px solid #e5e5e5;background:#16a085;display:inline-block;padding:10px 20px;color:white;font-weight:600;font-size:14px;border-radius:4px;transition:all .3s}
            .product-grid4:hover .add-to-cart{border:1px solid transparent;background:#86c9bb;color:#fff}
            .product-grid4 .add-to-cart:hover{background-color:#505050;color:#fff !important;cursor:pointer;}
            .product-grid4 .add-to-cart a:hover{color:white!important}
            .product-grid4 .delete-to-cart{border:1px solid #e5e5e5;display:inline-block;padding:10px 20px;color:white;font-weight:600;font-size:14px;border-radius:4px;transition:all .3s;background:#fc1616;}
            .product-grid4:hover .delete-to-cart{border:1px solid transparent;background:#ff8181;color:#fff}
            .product-grid4 .delete-to-cart:hover{background-color:#505050;box-shadow:0 0 10px rgba(0,0,0,.5);color:##fff!important;cursor:pointer;}
            .product-grid4 .delete-to-cart a:hover{color:##fff!important;}
